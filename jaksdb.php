<?php
/**
 * WordPress DB Class repackaged for jaksons database...fuck you wordpress
 *
...
//			}
	...
	function _real_escape( $string ) {
		...
		if ( function_exists( '__' ) ) {
			...
			echo $class.'<br>', sprintf( '%s must set a database connection for use with escaping.', $class );
		} else {
			echo $class, sprintf( '<br />%s must set a database connection for use with escaping.', $class );
		}
		return addslashes( $string );
	}
	...
	public function prepare( $query, $args ) {
		...
		if ( strpos( $query, '%' ) === false ) {
			echo 'db::prepare<br />', 'The query argument of %s must have a placeholder.<br />' , 'db::prepare()<br />', '3.9<br />';
            printData($query);
            printData($args);
		}
